...
<table border="0">
  <tr>
    ...
    <select name="bulletproof_security_options_idle_session[bps_isl]" class="form-250">
  ...
  <tr>
    ...
    <input type="text" name="bulletproof_security_options_idle_session[bps_isl_timeout]" class="regular-text-250" value="<?php if ( $BPS_ISL_options['bps_isl_timeout'] != '' ) { echo preg_replace( '/\D/', "", esc_html( $BPS_ISL_options['bps_isl_timeout'] ) ); } else { echo esc_html('60'); } ?>" />
    </td>
  </tr>
  <tr>
    <td>
    <label for="LSLog"><?php _e('Idle Session Logout Page URL:', 'bulletproof-security'); ?></label><br />
    <input type="text" name="bulletproof_security_options_idle_session[bps_isl_logout_url]" class="regular-text-450" value="<?php if ( $BPS_ISL_options['bps_isl_logout_url'] != '' ) { echo esc_url( $BPS_ISL_options['bps_isl_logout_url'] ); } else { echo esc_url( plugins_url('/bulletproof-security/isl-logout.php') ); } ?>" />
    </td>
  </tr>
  <tr>
    <td>
    ...
    <input type="text" name="bulletproof_security_options_idle_session[bps_isl_login_url]" class="regular-text-450" value="<?php if ( $BPS_ISL_options['bps_isl_login_url'] != '' ) { echo esc_html( $BPS_ISL_options['bps_isl_login_url'] ); } else { echo esc_url( site_url( '/wp-login.php' ) ); } ?>" />
    </td>
  </tr>
  <tr>
    <td>
	...
	<label><strong><i><?php _e('Enter URIs separated by a comma and a space: /some-post/, /some-page/', 'bulletproof-security'); ?></i></strong></label><br />
 	<textarea class="PFW-Allow-From-Text-Area" name="bulletproof_security_options_idle_session[bps_isl_uri_exclusions]" tabindex="1"><?php if ( $BPS_ISL_options['bps_isl_uri_exclusions'] != '' ) { echo esc_html( $BPS_ISL_options['bps_isl_uri_exclusions'] ); } else { echo esc_html(''); } ?></textarea>
  ...
  <tr>
    ...
    <label for="LSLog"><?php _e('Idle Session Logout Page Custom Message:', 'bulletproof-security'); ?></label><br />
 	<textarea class="PFW-Allow-From-Text-Area" name="bulletproof_security_options_idle_session[bps_isl_custom_message]" tabindex="1"><?php if ( $BPS_ISL_options['bps_isl_custom_message'] != '' ) { echo esc_html( $BPS_ISL_options['bps_isl_custom_message'] ); } else { echo esc_html(''); } ?></textarea>
	<input type="hidden" name="scrolltoISLMessage" id="scrolltoISLMessage" value="<?php echo esc_html( $scrolltoISLMessage ); ?>" />
    </td>
  </tr>
  <tr>
	...
	<label><strong><?php echo 'body {'; ?></strong></label><input type="text" name="bulletproof_security_options_idle_session[bps_isl_custom_css_1]" class="bps_isl_custom_css_1" value="<?php if ( $BPS_ISL_options['bps_isl_custom_css_1'] != '' ) { echo esc_html( $BPS_ISL_options['bps_isl_custom_css_1'] ); } else { echo esc_html( 'background-color:#fff;line-height:normal;' ); } ?>" /><label><strong><?php echo '}'; ?></strong></label><br />
	<label><strong><?php echo '#bpsMessage {'; ?></strong></label><input type="text" name="bulletproof_security_options_idle_session[bps_isl_custom_css_2]" class="bps_isl_custom_css_2" value="<?php if ( $BPS_ISL_options['bps_isl_custom_css_2'] != '' ) { echo esc_html( $BPS_ISL_options['bps_isl_custom_css_2'] ); } else { echo esc_html( 'position:fixed;top:20%;left:0%;text-align:center;height:100%;width:100%;' ); } ?>" /><label><strong><?php echo '}'; ?></strong></label><br />
	<label><strong><?php echo '#bpsMessageTextBox {'; ?></strong></label><input type="text" name="bulletproof_security_options_idle_session[bps_isl_custom_css_3]" class="bps_isl_custom_css_3" value="<?php if ( $BPS_ISL_options['bps_isl_custom_css_3'] != '' ) { echo esc_html( $BPS_ISL_options['bps_isl_custom_css_3'] ); } else { echo esc_html( 'border:5px solid gray;background-color:#BCE2F1;' ); } ?>" /><label><strong><?php echo '}'; ?></strong></label><br />
	<label><strong><?php echo 'p {'; ?></strong></label><input type="text" name="bulletproof_security_options_idle_session[bps_isl_custom_css_4]" class="bps_isl_custom_css_4" value="<?php if ( $BPS_ISL_options['bps_isl_custom_css_4'] != '' ) { echo esc_html( $BPS_ISL_options['bps_isl_custom_css_4'] ); } else { echo esc_html( 'font-family:Verdana, Arial, Helvetica, sans-serif;font-size:18px;font-weight:bold;' ); } ?>" /><label><strong><?php echo '}'; ?></strong></label><br />
    </td>
  </tr>
  <tr>
    <td>
    ...
    <input type="text" name="bulletproof_security_options_idle_session[bps_isl_user_account_exceptions]" class="regular-text-450" value="<?php if ( $BPS_ISL_options['bps_isl_user_account_exceptions'] != '' ) { echo esc_html( $BPS_ISL_options['bps_isl_user_account_exceptions'] ); } else { echo esc_html(''); } ?>" />
	</td>
  </tr>
  <tr>
	<td>
...
<table border="0">
  <tr>
    <td>
    <label for="LSLog"><?php _e('Turn On|Turn Off:', 'bulletproof-security'); ?></label><br />
    <select name="bulletproof_security_options_auth_cookie[bps_ace]" class="form-250"><br />
  ...
  <tr>
    ...
    <input type="text" name="bulletproof_security_options_auth_cookie[bps_ace_expiration]" class="regular-text-250" value="<?php if ( $BPS_ACE_options['bps_ace_expiration'] != '' ) { echo preg_replace( '/\D/', "", esc_html( $BPS_ACE_options['bps_ace_expiration'] )); } else { echo esc_html('2880'); } ?>" />
    </td>
  </tr>
  <tr>
    <td>
    ...
    <input type="text" name="bulletproof_security_options_auth_cookie[bps_ace_rememberme_expiration]" class="regular-text-250" value="<?php if ( $BPS_ACE_options['bps_ace_rememberme_expiration'] != '' ) { echo preg_replace( '/\D/', "", esc_html( $BPS_ACE_options['bps_ace_rememberme_expiration'] )); } else { echo esc_html('20160'); } ?>" />
	</td>
  </tr>
  <tr>
    <td>
    ...
    <input type="text" name="bulletproof_security_options_auth_cookie[bps_ace_user_account_exceptions]" class="regular-text-450" value="<?php if ( $BPS_ACE_options['bps_ace_user_account_exceptions'] != '' ) { echo esc_html( $BPS_ACE_options['bps_ace_user_account_exceptions'] ); } else { echo esc_html(''); } ?>" />
	</td>
  </tr>
  <tr>
	<td>
