...
// BPS variables
define( 'BULLETPROOF_VERSION', '.54.1' );
$bps_last_version = '.54';
$bps_version = '.54.1';
...
static $this_plugin;
	...
	if ( $file == $this_plugin ) {
		...
		$links[] = '<a href="http://www.ait-pro.com/bps-features/" title="BPS Pro Features" target="_blank">'.__('BPS Pro Features', 'bulleproof-security').'</a>';
	}
	return $links;
}
